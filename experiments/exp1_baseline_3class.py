...
def main():
    print("=== Experiment 1: Handcrafted LR baseline (3-class) ===")
    ensure_results_dir()
    ...
    json_path = os.path.join(RESULTS_DIR, "exp1_baseline_3class.json")
    cm_path = os.path.join(RESULTS_DIR, "exp1_baseline_3class_cm.png")
    ...
    save_json(
        json_path,
        {
            "experiment": "exp1_baseline_3class",
            "label_mode": "rest_2_3",
    ...
    print("Saved results to results/exp1_baseline_3class.json")
