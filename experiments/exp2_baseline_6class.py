...
def main():
    print("=== Experiment 2: Handcrafted LR baseline (6-class) ===")
    ensure_results_dir()
    ...
    json_path = os.path.join(RESULTS_DIR, "exp2_baseline_6class.json")
    cm_path = os.path.join(RESULTS_DIR, "exp2_baseline_6class_cm.png")
    ...
    save_json(
        json_path,
        {
            "experiment": "exp2_baseline_6class",
            "label_mode": "full_6",
    ...
    print("Saved results to results/exp2_baseline_6class.json")
