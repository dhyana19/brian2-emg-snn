...
def main():
    print("=== Experiment 4: Hybrid SNN + handcrafted features (3-class) ===")
    ensure_results_dir()

    split = load_subject_split("rest_2_3")
    train_cache_path = os.path.join(RESULTS_DIR, "exp4_hybrid_3class_train_features.npz")
    test_cache_path = os.path.join(RESULTS_DIR, "exp4_hybrid_3class_test_features.npz")
    print(
    ...
    json_path = os.path.join(RESULTS_DIR, "exp4_hybrid_3class.json")
    cm_path = os.path.join(RESULTS_DIR, "exp4_hybrid_3class_cm.png")
    ...
    print("Saved results to results/exp4_hybrid_3class.json")
